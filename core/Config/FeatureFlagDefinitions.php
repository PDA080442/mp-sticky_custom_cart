...
final class FeatureFlagDefinitions {
	...
	public static function labels() {
		return array(
			...
			FeatureFlagsDefaults::KEY_STICKY_HIDE_WHEN_EMPTY_ENABLED   => __( 'Плавающая корзина: скрывать при пустой корзине', 'mp-sticky-custom-cart' ),
	...
	public static function descriptions() {
		return array(
			...
			FeatureFlagsDefaults::KEY_STICKY_HIDE_WHEN_EMPTY_ENABLED => __( 'При первой загрузке и после очистки корзины не рендерить shell и не резервировать padding у body; после добавления товара shell подгружается по AJAX без CLS до появления.', 'mp-sticky-custom-cart' ),
	...
	public static function ordered_keys() {
		return array(
			...
			FeatureFlagsDefaults::KEY_STICKY_HIDE_WHEN_EMPTY_ENABLED,
